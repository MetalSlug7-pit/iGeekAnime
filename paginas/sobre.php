...
<body style="visibility: hidden !important; background-color: #171616;">
    ...
    <img style="width: 100%; height: 658px;" src="../imagens/mascot/mascotSobre.png">

	<header>
		<center><h1>O seu catálogo de animes!</h1></center>
	</header>
	<main>
		<section class="sobre-nos">
			<h2>Sobre Nós</h2>
			<p>Somos apaixonados por animes e criamos o iGeekAnime para ajudar pessoas a encontrarem todas as obras em um uníco lugar!</p>
			<div class="criadores">
				<div class="criador">
					<img src="../imagens/mascot/avatar1.png" alt="Foto do Criador 1">
					<h3>Pedro R Hadad</h3>
				</div>
				<div class="criador">
					<img src="../imagens/mascot/avatar2.png" alt="Foto do Criador 2">
					<h3>Gustavo S Valentim</h3>
				</div>
			</div>
			<h2>Nossa História</h2>
			<p style="text-align: justify;">Há muitos anos, notamos que as pessoas enfrentavam dificuldades para encontrar obras relacionadas à cultura otaku em geral, como animes, mangás e novels. Então, quando começamos a fazer o curso de ADS, decidimos criar um projeto para ajudar as pessoas a encontrar qualquer tipo de obra. Assim, surgiu o iGeekAnime, um extenso catálogo de obras focado na cultura japonesa e derivados.</p>
		</section>
	</main>
