...
<body style="visibility: hidden !important; background-color: #171616;">
	...
	<div class="termos">
        ...
        <p>O iGeekAnime valoriza a privacidade dos seus usuários e está comprometido em proteger as informações pessoais que coletamos. Esta Política de Privacidade descreve como o iGeekAnime coleta, usa, armazena e protege suas informações pessoais. Ao utilizar este site, você concorda com esta Política de Privacidade.</p>
        
        <h2>Informações Coletadas</h2>
        <p>O iGeekAnime coleta informações pessoais quando você se registra no site, preenche formulários, faz comentários ou envia mensagens. As informações que coletamos incluem seu nome, endereço de e-mail e outras informações. Também podemos coletar informações sobre o seu uso do site, incluindo o seu histórico de navegação e atividades no site.</p>

        <h2>Uso das Informações</h2>
        <p>O iGeekAnime utiliza as informações coletadas para fornecer serviços e recursos do site, enviar comunicações, personalizar sua experiência de usuário e melhorar o site. Podemos também utilizar as informações para fins de pesquisa e análise. Não compartilhamos suas informações pessoais com terceiros, exceto quando necessário para cumprir as leis aplicáveis.</p>

        <h2>Cookies e Tecnologias Similares</h2>
        <p>O iGeekAnime utiliza cookies e tecnologias similares para coletar informações sobre o seu uso do site. Os cookies são arquivos de texto armazenados no seu computador que nos ajudam a identificar usuários e personalizar sua experiência. Você pode configurar seu navegador para recusar cookies, mas isso pode limitar sua capacidade de usar o site.</p>

        <h2>Segurança das Informações</h2>
        <p>O iGeekAnime toma medidas razoáveis para proteger suas informações pessoais contra perda, uso indevido, acesso não autorizado, divulgação, alteração ou destruição. No entanto, nenhuma transmissão de dados pela Internet é 100% segura e não podemos garantir a segurança das informações que você transmite para o site.</p>

		<h2>Alterações nesta Política de Privacidade</h2>
        <p>O iGeekAnime reserva-se o direito de modificar esta Política de Privacidade a qualquer momento, sem aviso prévio. Recomendamos que você reveja esta Política de Privacidade periodicamente. Ao continuar a usar o site após as alterações, você concorda em ficar vinculado pelos novos termos.</p>
    </div>
