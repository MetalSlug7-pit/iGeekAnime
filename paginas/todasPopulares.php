...
$resultPopular = $conn->query("SELECT idObra, count(idObra) from Favoritar_obra_usuario group by idObra order by count(idObra) DESC LIMIT 50");
				...
				?>
					...
					?>		
							<div class="obra">
								...
								<a href="obras/obras.php?id=<?php echo $row_pop['obras_id'];?>" class="overlay"></a>
							</div>
					<?php 
						}
						}
