...
$resultUltimaAdd = $conn->query("SELECT * FROM Obras ORDER BY dataLancamento DESC LIMIT 50");
			...
			<div class="obras">
				...
				?>		
							<div class="obra">
								...
								<a href="obras/obras.php?id=<?php echo $obraUltimaAdd['obras_id'];?>" class="overlay"></a>
							</div>
					<?php 
						}
						}
