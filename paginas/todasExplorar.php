					...
					?>
						...
						?>		
								<div class="obra">
									...
									<a href="obras/obras.php?id=<?php echo $row_exp['obras_id'];?>" class="overlay"></a>
								</div>
						<?php 
							}
							}
						...
						?>
									<div class="obra">
										<img src="<?php echo $row_exp['imagemObra'];?>">
										<h3><?php echo $row_exp['nome'];?></h3>
										<a href="obras/obras.php?id=<?php echo $row_exp['obras_id'];?>" class="overlay">
											<svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-history" viewBox="0 0 24 24" stroke-width="1.5" stroke="#ffffff" fill="none" stroke-linecap="round" stroke-linejoin="round">
											<path stroke="none" d="M0 0h24v24H0z" fill="none"/>
