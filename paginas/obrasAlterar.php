...
<body style="background-color: #171616;">
	...
	<div class="Busca">
		<form method="POST" class="formPesquisa" action="">
			<center><input placeholder="Buscar.." name="pesquisaObra" id="pesquisaObra" class="barraPesquisar"/></center>
		</form>
	</div>
	...
	<?php
		if(isset($_SESSION['obra_alterada'])):
	?>
		<body onload="obraAtt()"></body>
	<?php
		endif;
		unset($_SESSION['obra_alterada']);
	?>
			...
			<div class="obras">
				...
				?>		
							<div class="obra">
								...
								<a href="alterarObras.php?id=<?php echo $imgObra['obras_id'];?>" class="overlay"></a>
							</div>
					<?php 
						}
						}
