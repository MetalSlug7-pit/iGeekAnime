...
<body style="visibility: hidden !important; background-color: #171616;">
	...
	<div class="termos">
        <h1>Termos de Uso</h1>
        <p>Bem-vindo ao iGeekAnime! Este site foi criado para indexar obras da cultura otaku, como animes, mangás, light novels e outros conteúdos relacionados. Ao utilizar este site, você concorda com os seguintes termos:</p>
        
        <h2>Propriedade Intelectual</h2>
        <p>Todo o conteúdo do iGeekAnime, incluindo texto, imagens, vídeos e outros materiais são de propriedade do site ou de seus respectivos proprietários e são protegidos por leis de direitos autorais e outras leis de propriedade intelectual. Você concorda em não copiar, distribuir, reproduzir, modificar ou criar obras derivadas do conteúdo sem a permissão expressa do proprietário dos direitos autorais.</p>

        <h2>Responsabilidade do Usuário</h2>
        <p>Você é responsável por todas as atividades que ocorrem em sua conta no iGeekAnime e concorda em não usar o site para fins ilegais ou prejudiciais. Você concorda em não enviar conteúdo ofensivo, abusivo, difamatório, pornográfico, ou que viole direitos autorais ou de privacidade. O iGeekAnime se reserva o direito de remover qualquer conteúdo que considere inadequado.</p>

        <h2>Limitação de Responsabilidade</h2>
        <p>O iGeekAnime não se responsabiliza por quaisquer danos diretos, indiretos, incidentais, especiais ou consequentes que surjam do uso ou incapacidade de usar o site, incluindo, mas não se limitando a, danos por perda de lucro, perda de dados ou interrupção de negócios.</p>

        <h2>Alterações nos Termos de Uso</h2>
        <p>O iGeekAnime reserva-se o direito de modificar estes termos de uso a qualquer momento, sem aviso prévio. Ao continuar a usar o site após as alterações, você concorda em ficar vinculado pelos novos termos.</p>
    </div>
