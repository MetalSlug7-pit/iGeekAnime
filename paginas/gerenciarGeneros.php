...
<head>
	...
	<link rel="stylesheet" type="text/css" href="../css/gerenciarGeneros.css"/>
...
<body style="background-color: #171616;">
	<nav class="navbar navbar-expand-lg bg-dark">
		...
		<?php
			if(isset($_SESSION['genero_inserido'])):
		?>
			<body onload="generoAdicionado()"></body>
		<?php
			endif;
			unset($_SESSION['genero_inserido']);
		?>

		<?php
			if(isset($_SESSION['genero_existe'])):
		?>
			<body onload="generoExiste()"></body>	
		<?php
			endif;
			unset($_SESSION['genero_existe']);
		?>

		<?php
			if(isset($_SESSION['genero_removido'])):
		?>
			<body onload="generoRemovido()"></body>
		<?php
			endif;
			unset($_SESSION['genero_removido']);
		?>

        <div class="container">
			<div class="adicionar" onclick="addGen()">
            	<label class="tituloAdd">Adicionar Genêros</label>
        	</div>	


        	<div class="excluir" onclick="delGen()">
            	<label class="tituloExc">Excluir Genêros</label>
			</div>
